...
from ansiblite.errors import AnsibleParserError, AnsibleUndefinedVariable, AnsibleFileNotFound
...
def load_list_of_tasks(ds, play, block=None, role=None, task_include=None, use_handlers=False, variable_manager=None, loader=None):
    ...
    # we import here to prevent a circular dependency with imports
    from ansiblite.playbook.block import Block
    from ansiblite.playbook.handler import Handler
    from ansiblite.playbook.task import Task
    from ansiblite.playbook.task_include import TaskInclude
    from ansiblite.playbook.role_include import IncludeRole
    from ansiblite.playbook.handler_task_include import HandlerTaskInclude
