...
from ansiblite.inventory.ini import InventoryParser as InventoryINIParser
from ansiblite.inventory.yaml import InventoryParser as InventoryYAMLParser
from ansiblite.inventory.script import InventoryScript
